    ...
    return (
        <PageWrapper>
            ...
            <div className="flex justify-start items-start flex-col gap-3 rounded-md p-6 shadow-md text-white bg-zinc-900 sm:w-96 w-80">
                ...
                <span>{t("sign-into-your-account")}</span>

                <InputField type="email" placeholder={t("email")} setState={(value) => setCredentials({...credentials, email: value})} 
                fieldError={!credentials.email && buttonPressed}/>

                <InputField type="password" placeholder={t("password")} setState={(value) => setCredentials({...credentials, password: value})} 
