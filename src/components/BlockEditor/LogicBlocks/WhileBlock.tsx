    ...
    return (
        <>
            ...
            border-2 border-indigo-900">
                <h1 className="text-white text-lg font-semibold px-2">While loop</h1>
                <DetachButton parent={block} port={0} position="right"/>

                <div className="flex items-center rounded-md w-full my-2">

                    <div className="bg-indigo-600 rounded-md px-2 mr-2 w-16 h-16
                    min-w-12 flex justify-center items-center">
                        <h1 className="text-white text-lg font-semibold">While</h1>
                    </div>
